...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ultimaker
  #define DEFAULT_Kp 17.62//22.2
  #define DEFAULT_Ki 0.85//1.08
  #define DEFAULT_Kd 91.68//114
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 394.99//10.00
  #define DEFAULT_bedKi 74.18//.023
  #define DEFAULT_bedKd 525.83//305.4
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 2000, 838}
//{ 80, 80, 4000, 500 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 50, 50, 2, 25 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 50, 50, 10, 10000 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.20   // Z offset: -below +above  [the nozzle]
